...
/**
 * 
 * @description: FTP客户端封装,ftp上传下载文件
 * @author: libl  
 * @date: 2019年2月18日
 */
public class FtpCilentUtil extends AbstractFtp {
	...
	public FtpCilentUtil() {
		this(ftpIp, ftpPort, ftpUsername, ftpPassword);
	}
	 ...
	 *            域名或IP
	 */
	public FtpCilentUtil(String host) {
	 ...
	 *            端口
	 */
	public FtpCilentUtil(String host, int port) {
	 ...
	 *            密码
	 */
	public FtpCilentUtil(String host, int port, String user, String password) {
	 ...
	 *            编码
	 */
	public FtpCilentUtil(String host, int port, String user, String password, Charset charset) {
	 ...
	 * @return this
	 */
	public FtpCilentUtil init(String host, int port, String user, String password) {
	 ...
	 * @since 4.1.19
	 */
	public FtpCilentUtil setMode(FtpMode mode) {
		switch (mode) {
		case Active:
	...
	public List<String> ls(String path) {
		try {
			return Arrays.asList(this.client.listNames(path));
		} catch (IOException e) {
			throw new FtpException(e);
		}
	}
